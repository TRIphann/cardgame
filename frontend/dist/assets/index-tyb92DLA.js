const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GamePage-Dk3l4-RT.js","assets/react-BhVOh7S1.js","assets/vendor-DcE7maHo.js","assets/router-DRJyKT9H.js","assets/react-dom-HPixZcWd.js"])))=>i.map(i=>d[i]);
...
const GamePage = reactExports.lazy(() => __vitePreload(() => import("./GamePage-Dk3l4-RT.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
function App() {
  const location = useLocation();
